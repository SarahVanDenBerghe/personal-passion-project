...
for(var c=0;c<b.length;c+=3){var d=b[c+2],g=f.get(d);g||f.set(d,g=[]);g.push({x:b[c],y:d,height:a,charIndex:c/3});c+3>=b.length&&g.push({x:b[c+1],y:d,height:a,charIndex:c/3+1})}}ra.set(k,f);return f}function sa(){var k=R.createDerivedMaterial(new x.MeshBasicMaterial({transparent:!0,opacity:.3,depthWrite:!1}),{uniforms:{rect:{value:new x.Vector4}},vertexDefs:"uniform vec4 rect;",vertexTransform:"\n  position.x = position.x < 0.0 ? rect.x : rect.z;\n  position.y = position.y < 0.0 ? rect.w : rect.y;\n  "});
k.instanceUniforms=["rect","diffuse"];var f=new x.Mesh((new x.BoxBufferGeometry).translate(0,0,-.5),k);return(sa=function(){return f})()}var O=G.defineWorkerModule({name:"Typr Font Parser",dependencies:[function(){var k=self,f={parse:function(b){var a=f._bin;b=new Uint8Array(b);if("ttcf"==a.readASCII(b,0,4)){var c=4;a.readUshort(b,c);c+=2;a.readUshort(b,c);c+=2;var d=a.readUint(b,c);c+=4;for(var g=[],e=0;e<d;e++){var h=a.readUint(b,c);c+=4;g.push(f._readFont(b,h))}return g}return[f._readFont(b,0)]},
...
g;e++){var f=a[p[e]];d.length=1+f;d[0]=p[e];for(var h=1;h<=f;h++)d[h]=r[b++];c.apply(null,d)}}}}m.call(null,q,e,n);q.advanceWidth&&(e+=q.advanceWidth*h);l&&(e+=l*f)}n+=65535<d.codePointAt(n)?2:1});return e}};return g}var a={M:2,L:2,Q:4,C:6,Z:0};return function(a){var c=new Uint8Array(a,0,4);c=k._bin.readASCII(c,0,4);if("wOFF"===c)a=f(a);else if("wOF2"===c)throw Error("woff2 fonts not supported");return b(k.parse(a)[0])}}],init:function(k,f,b){k=k();f=f();return b(k,f)}}),N={defaultFontURL:"https://fonts.gstatic.com/s/roboto/v18/KFOmCnqEu92Fr1Mu4mxM.woff",
sdfGlyphSize:64,textureWidth:2048},Ba=new x.Color,ma=Object.create(null),S;O=G.defineWorkerModule({name:"FontProcessor",dependencies:[N,.125,O,function(k){function f(a,c){var b=a.minX,d=a.minY,e=a.maxX,g=a.maxY,h=a.cx,l=a.cy;b<c.minX&&(c.minX=b);d<c.minY&&(c.minY=d);e>c.maxX&&(c.maxX=e);g>c.maxY&&(c.maxY=g);var k=c.data;if(k)if(k.cx===h&&k.cy===l){for(;k.next;)k=k.next;k.next=a}else c.data=null,f(k,c),f(a,c);else h=(l<c.cy?0:2)+(h<c.cx?0:1),c[h]?f(a,c[h]):c[h]={0:null,1:null,2:null,3:null,data:a,
...
(r="normal");var t=a.maxWidth;void 0===t&&(t=Infinity);var x=a.textAlign;void 0===x&&(x="left");var C=a.whiteSpace;void 0===C&&(C="normal");var D=a.overflowWrap;void 0===D&&(D="normal");var B=a.anchorX;void 0===B&&(B=0);var H=a.anchorY;void 0===H&&(H=0);var z=a.includeCaretPositions;void 0===z&&(z=!1);var G=a.chunkedBoundsSize;void 0===G&&(G=8192);var P=a.colorRanges;void 0===P&&(P=null);void 0===b&&(b=!1);var N=h(),L={total:0,fontLoad:0,layout:0,sdf:{},sdfTotal:0};-1<g.indexOf("\r")&&(console.warn("FontProcessor.process: got text with \\r chars; normalizing to \\n"),
g=g.replace(/\r\n/g,"\n").replace(/\r/g,"\n"));n=+n;p=+p;t=+t;r=r||"normal";d(k,function(a){var d=a.fontObj,k=isFinite(t),m=null,q=null,u=null,w=null,v=null,y=null,A=null,E=0,F=0,R="nowrap"!==C,aa=d.ascender,T=d.descender,ba=d.unitsPerEm;L.fontLoad=h()-N;var S=h(),J=n/ba;"normal"===r&&(r=(aa-T)/ba);r*=n;ba=(r-(aa-T)*J)/2;var O=-(n+ba),Q=Math.min(r,(aa-T)*J),X=(aa+T)/2*J-Q/2,U=0,I=new l,V=[I];d.forEachGlyph(g,n,p,function(a,c,b){var d=g.charAt(b),e=a.advanceWidth*J,f=I.count;"isEmpty"in a||(a.isWhitespace=
!!d&&/\s/.test(d),a.isEmpty=a.xMin===a.xMax||a.yMin===a.yMax);a.isWhitespace||a.isEmpty||F++;if(R&&k&&!a.isWhitespace&&c+e+U>t&&f){if(I.glyphAt(f-1).glyphObj.isWhitespace){var h=new l;U=-c}else for(;f--;)if(0===f&&"break-word"===D){h=new l;U=-c;break}else if(I.glyphAt(f).glyphObj.isWhitespace){h=I.splitAt(f+1);f=h.glyphAt(0).x;U-=f;for(var m=h.count;m--;)h.glyphAt(m).x-=f;break}h&&(I.isSoftWrapped=!0,I=h,V.push(I),E=t)}h=I.glyphAt(I.count);h.glyphObj=a;h.x=c+U;h.width=e;h.charIndex=b;"\n"===d&&(I=
new l,V.push(I),U=-(c+e+p*n))});V.forEach(function(a){for(var c=a.count;c--;){var b=a.glyphAt(c),d=b.x,e=b.width;if(!b.glyphObj.isWhitespace){a.width=d+e;a.width>E&&(E=a.width);break}}});if(!b){var W=0,ca=0;B&&("number"===typeof B?W=-B:"string"===typeof B&&(W=-E*("left"===B?0:"center"===B?.5:"right"===B?1:e(B))));H&&("number"===typeof H?ca=-H:"string"===typeof H&&(d=V.length*r,ca="top"===H?0:"top-baseline"===H?-O:"middle"===H?d/2:"bottom"===H?d:"bottom-baseline"===H?d-ba+T*J:e(H)*d));q=new Float32Array(4*
F);u=new Float32Array(F);y=[Infinity,Infinity,-Infinity,-Infinity];A=[];var da=O;z&&(v=new Float32Array(3*g.length));P&&(w=new Uint8Array(3*F));var Y=0,M=-1,ea=-1,K,fa;V.forEach(function(c){var b=c.count,d=c.width;if(0<b){var e=0,k=0;if("center"===x)e=(E-d)/2;else if("right"===x)e=E-d;else if("justify"===x&&c.isSoftWrapped){k=0;for(var l=b;l--;)if(!c.glyphAt(l).glyphObj.isWhitespace){for(;l--;){if(!c.glyphAt(l).glyphObj)debugger;c.glyphAt(l).glyphObj.isWhitespace&&k++}break}k=(E-d)/k}for(d=0;d<b;d++){l=
c.glyphAt(d);var n=l.glyphObj;e&&(l.x+=e);0!==k&&n.isWhitespace&&(e+=k,l.width+=k);if(z){var p=l.charIndex;v[3*p]=l.x+W;v[3*p+1]=l.x+l.width+W;for(v[3*p+2]=da+X+ca;1<p-M;)v[3*(M+1)]=v[3*M+1],v[3*(M+1)+1]=v[3*M+1],v[3*(M+1)+2]=v[3*M+2],M++;M=p}if(P)for(p=l.charIndex;p>ea;)ea++,P.hasOwnProperty(ea)&&(fa=P[ea]);if(!n.isWhitespace&&!n.isEmpty){p=Y++;var t=a.glyphs[n.index];if(!t){t=h();var B=f(n);L.sdf[g.charAt(l.charIndex)]=h()-t;B.atlasIndex=a.glyphCount++;m||(m=[]);m.push(B);t=a.glyphs[n.index]={atlasIndex:B.atlasIndex,
glyphObj:n,renderingBounds:B.renderingBounds}}var C=t.renderingBounds,D=4*p;n=q[D]=l.x+C[0]*J+W;B=q[D+1]=da+C[1]*J+ca;l=q[D+2]=l.x+C[2]*J+W;C=q[D+3]=da+C[3]*J+ca;n<y[0]&&(y[0]=n);B<y[1]&&(y[1]=B);l>y[2]&&(y[2]=l);C>y[3]&&(y[3]=C);0===p%G&&(K={start:p,end:p,rect:[Infinity,Infinity,-Infinity,-Infinity]},A.push(K));K.end++;n<K.rect[0]&&(K.rect[0]=n);B<K.rect[1]&&(K.rect[1]=B);l>K.rect[2]&&(K.rect[2]=l);C>K.rect[3]&&(K.rect[3]=C);u[p]=t.atlasIndex;P&&(l=3*p,w[l]=fa>>16&255,w[l+1]=fa>>8&255,w[l+2]=fa&
255)}}}da-=r})}for(var Z in L.sdf)L.sdfTotal+=L.sdf[Z];L.layout=h()-S-L.sdfTotal;L.total=h()-N;c({glyphBounds:q,glyphAtlasIndices:u,caretPositions:v,caretHeight:Q,glyphColors:w,chunkedBounds:A,ascender:aa*J,descender:T*J,lineHeight:r,topBaseline:O,totalBounds:y,totalBlockSize:[E,V.length*r],newGlyphSDFs:m,timings:L})})}function e(a){a=(a=a.match(/^([\d.]+)%$/))?parseFloat(a[1]):NaN;return isNaN(a)?0:a/100}function h(){return(self.performance||Date).now()}function l(){this.data=[]}var m=b.defaultFontUrl,
t=Object.create(null);l.prototype={width:0,isSoftWrapped:!1,get count(){return Math.ceil(this.data.length/4)},glyphAt:function(a){var c=l.flyweight;c.data=this.data;c.index=a;return c},splitAt:function(a){var c=new l;c.data=this.data.splice(4*a);return c}};l.flyweight=["glyphObj","x","width","charIndex"].reduce(function(a,c,b,d){Object.defineProperty(a,c,{get:function(){return this.data[4*this.index+b]},set:function(a){this.data[4*this.index+b]=a}});return a},{data:null,index:0});return{process:g,
measure:function(a,c){g(a,function(a){c({width:a.totalBlockSize[0],height:a.totalBlockSize[1]})},{metricsOnly:!0})},loadFont:c}}],init:function(k,f,b,a,c,d){f=c(a,{sdfTextureSize:k.sdfGlyphSize,sdfDistancePercent:f});return d(b,f,{defaultFontUrl:k.defaultFontURL})}});var Ca=G.defineWorkerModule({name:"TextBuilder",dependencies:[O,G.ThenableWorkerModule],init:function(k,f){return function(b){var a=new f;k.process(b,a.resolve);return a}},getTransferables:function(k){var f=[k.glyphBounds.buffer,k.glyphAtlasIndices.buffer];
k.caretPositions&&f.push(k.caretPositions.buffer);k.newGlyphSDFs&&k.newGlyphSDFs.forEach(function(b){f.push(b.textureData.buffer)});return f}}),na={},Ga=new x.Vector3,Q=function(k){function f(){k.call(this);this.detail=1;this.boundingSphere=new x.Sphere}k&&(f.__proto__=k);f.prototype=Object.create(k&&k.prototype);f.prototype.constructor=f;var b={detail:{configurable:!0}};f.prototype.computeBoundingSphere=function(){};b.detail.set=function(a){var c=this;if(a!==this._detail){this._detail=a;if("number"!==
typeof a||1>a)a=1;var b=Da(a);["position","normal","uv"].forEach(function(a){c.attributes[a]=b.attributes[a]});this.setIndex(b.getIndex())}};b.detail.get=function(){return this._detail};f.prototype.updateGlyphs=function(a,c,b,g,e){Y(this,"aTroikaGlyphBounds",a,4);Y(this,"aTroikaGlyphIndex",c,1);Y(this,"aTroikaGlyphColor",e,3);this._chunkedBounds=g;oa(this,c.length);a=this.boundingSphere;a.center.set((b[0]+b[2])/2,(b[1]+b[3])/2,0);a.radius=a.center.distanceTo(Ga.set(b[0],b[1],0))};f.prototype.applyClipRect=
function(a){var c=this.getAttribute("aTroikaGlyphIndex").count,b=this._chunkedBounds;if(b)for(var g=b.length;g--;){c=b[g].end;var e=b[g].rect;if(e[1]<a.w&&e[3]>a.y&&e[0]<a.z&&e[2]>a.x)break}oa(this,c)};Object.defineProperties(f.prototype,b);return f}(x.InstancedBufferGeometry);Q.prototype.setAttribute||(Q.prototype.setAttribute=function(k,f){this.attributes[k]=f;return this});var ta=new x.MeshBasicMaterial({color:16777215,side:x.DoubleSide,transparent:!0}),ha=new x.Matrix4,ua=new x.Vector3,ia=new x.Vector3,
Ha=new x.Vector3,va=new x.Mesh((new x.PlaneBufferGeometry(1,1)).translate(.5,.5,0),ta),Ia={type:"syncstart"},Ja={type:"synccomplete"};G="font fontSize letterSpacing lineHeight maxWidth overflowWrap text textAlign whiteSpace anchorX anchorY colorRanges".split(" ");var Ka=G.concat("material","color","depthOffset","clipRect","orientation","glyphGeometryDetail"),X=function(k){function f(){var a=new Q;k.call(this,a,null);this.text="";this.anchorY=this.anchorX=0;this.font=null;this.fontSize=.1;this.letterSpacing=
...
null!=e&&a.color&&a.color.isColor&&e!==a._troikaColor&&a.color.set(a._troikaColor=e);e=this.orientation||"+x+y";if(e!==a._orientation){c=c.uTroikaOrient.value;e=e.replace(/[^-+xyz]/g,"");var h="+x+y"!==e&&e.match(/^([-+])([xyz])([-+])([xyz])$/);if(h){b=h[1];f=h[2];var k=h[3];h=h[4];ua.set(0,0,0)[f]="-"===b?1:-1;ia.set(0,0,0)[h]="-"===k?-1:1;ha.lookAt(Ha,ua.cross(ia),ia);c.setFromMatrix4(ha)}else c.identity();a._orientation=e}};f.prototype.raycast=function(a,c){var b=this.textRenderInfo;b&&(b=b.totalBounds,
va.matrixWorld.multiplyMatrices(this.matrixWorld,ha.set(b[2]-b[0],0,0,b[0],0,b[3]-b[1],0,b[1],0,0,1,0,0,0,0,1)),va.raycast(a,c))};f.prototype.copy=function(a){var c=this;k.prototype.copy.call(this,a);Ka.forEach(function(b){c[b]=a[b]});return this};f.prototype.clone=function(){return(new this.constructor).copy(this)};Object.defineProperties(f.prototype,b);return f}(x.Mesh);G.forEach(function(k){var f="_private_"+k;Object.defineProperty(X.prototype,k,{get:function(){return this[f]},set:function(b){b!==
this[f]&&(this[f]=b,this._needsSync=!0)}})});var wa=!1;Object.defineProperty(X.prototype,"anchor",{get:function(){return this._deprecated_anchor},set:function(k){this._deprecated_anchor=k;wa||(console.warn("TextMesh: `anchor` has been deprecated; use `anchorX` and `anchorY` instead."),wa=!0);Array.isArray(k)?(this.anchorX=100*(+k[0]||0)+"%",this.anchorY=100*(+k[1]||0)+"%"):this.anchorX=this.anchorY=0}});var qa=new WeakMap,ra=new WeakMap,xa=new x.Vector4,La=function(k){function f(b){k.call(this,b);
this.instancedThreeObject=sa();this._color=new x.Color;this._rect=new x.Vector4}k&&(f.__proto__=k);f.prototype=Object.create(k&&k.prototype);f.prototype.constructor=f;f.prototype.afterUpdate=function(){var b=this.top,a=this.right,c=this.bottom,d=this.left,f=this.color;this._color.equals(f)||this.setInstanceUniform("diffuse",this._color=new x.Color(f));this._rect.equals(xa.set(d,b,a,c))||this.setInstanceUniform("rect",xa.clone());k.prototype.afterUpdate.call(this)};f.prototype.getBoundingSphere=function(){return null};
return f}(R.Instanceable3DFacade),ya=new x.Matrix4,Ma=new x.Plane,Na=new x.Vector3,za=Object.freeze([-Infinity,-Infinity,Infinity,Infinity]),Oa=function(k){function f(a,b){var c=this;k.call(this,a);var f=a.threeObject;this.rangeColor=52479;this.clipRect=za;this.template={key:function(a,c){return"rect"+c},facade:La,top:function(a){return Math.min(c.clipRect[3],Math.max(c.clipRect[1],a.top))},right:function(a){return Math.min(c.clipRect[2],Math.max(c.clipRect[0],a.right))},bottom:function(a){return Math.min(c.clipRect[3],
Math.max(c.clipRect[1],a.bottom))},left:function(a){return Math.min(c.clipRect[2],Math.max(c.clipRect[0],a.left))},z:function(a){return.25*(a.top-a.bottom)/2},scaleZ:function(a){return.25*(a.top-a.bottom)},color:function(a){return c.rangeColor},visible:function(a){var b=c.clipRect;return a.right>b[0]&&a.top>b[1]&&a.left<b[2]&&a.bottom<b[3]},renderOrder:function(a){return c.renderOrder||0}};var e=function(d){var e=c.textRenderInfo;if(e){var g=d.intersection.point.clone().applyMatrix4(ya.getInverse(f.matrixWorld));
if(e=Z(e,g.x,g.y))b(e.charIndex,e.charIndex),a.addEventListener("drag",h),a.addEventListener("dragend",l);d.preventDefault()}},h=function(a){var d=f.textRenderInfo;if(a.ray&&d){var e=a.ray.clone().applyMatrix4(ya.getInverse(f.matrixWorld)).intersectPlane(Ma.setComponents(0,0,1,0),Na);e&&(d=Z(d,e.x,e.y))&&b(c.selectionStart,d.charIndex);a.preventDefault()}},l=function(c){a.removeEventListener("drag",h);a.removeEventListener("dragend",l)};a.addEventListener("dragstart",e);a.addEventListener("mousedown",
e);this._cleanupEvents=function(){l();a.removeEventListener("dragstart",e);a.removeEventListener("mousedown",e)}}k&&(f.__proto__=k);f.prototype=Object.create(k&&k.prototype);f.prototype.constructor=f;var b={clipRect:{configurable:!0}};f.prototype.afterUpdate=function(){this.data=pa(this.textRenderInfo,this.selectionStart,this.selectionEnd);k.prototype.afterUpdate.call(this)};b.clipRect.set=function(a){this._clipRect=a&&Array.isArray(a)&&4===a.length?a:za};b.clipRect.get=function(){return this._clipRect};
f.prototype.destructor=function(){this._cleanupEvents();k.prototype.destructor.call(this)};Object.defineProperties(f.prototype,b);return f}(R.ListFacade),Pa="text anchorX anchorY font fontSize letterSpacing lineHeight maxWidth overflowWrap textAlign whiteSpace material color colorRanges depthOffset clipRect orientation glyphGeometryDetail debugSDF".split(" ");G=function(k){function f(a){var c=this,b=new X;b.geometry.boundingSphere.version=0;k.call(this,a,b);this.selectable=!1;this.selectionStart=
this.selectionEnd=-1;this.onSyncComplete=this.onSyncStart=null;b.addEventListener("syncstart",function(a){c.notifyWorld("text3DSyncStart");if(c.onSyncStart)c.onSyncStart()});b.addEventListener("synccomplete",function(a){if(!c.isDestroying&&(b.geometry.boundingSphere.version++,c.afterUpdate(),c.notifyWorld("text3DSyncComplete"),c.notifyWorld("needsRender"),c.onSyncComplete))c.onSyncComplete()})}k&&(f.__proto__=k);f.prototype=Object.create(k&&k.prototype);f.prototype.constructor=f;var b={textRenderInfo:{configurable:!0}};
b.textRenderInfo.get=function(){return this.threeObject.textRenderInfo};f.prototype.afterUpdate=function(){var a=this,b=this.threeObject;Pa.forEach(function(c){b[c]=a[c]});b.sync();k.prototype.afterUpdate.call(this);this.text!==this._prevText&&(this.selectionStart=this.selectionEnd=-1,this._prevText=this.text);this._updateSelection()};f.prototype._updateSelection=function(){var a=this,b=this.selectable,d=this.selectionStart,f=this.selectionEnd,e=this._selectionFacade;b!==this._selectable&&((this._selectable=
b)?e=this._selectionFacade=new Oa(this,function(b,c){a.selectionStart=b;a.selectionEnd=c;a._updateSelection();a.notifyWorld("needsRender")}):(e&&(e.destructor(),e=this._selectionFacade=null),this.selectionStart=this.selectionEnd=-1));e&&(e.textRenderInfo=this.threeObject.textRenderInfo,e.selectionStart=d,e.selectionEnd=f,e.clipRect=this.clipRect,e.renderOrder=this.renderOrder,e.afterUpdate())};f.prototype.destructor=function(){this.threeObject.dispose();this._selectionFacade&&this._selectionFacade.destructor();
k.prototype.destructor.call(this)};Object.defineProperties(f.prototype,b);return f}(R.Object3DFacade);C.GlyphsGeometry=Q;C.Text3DFacade=G;C.TextMesh=X;C.configureTextBuilder=function(k){la(N,k)};C.fontProcessorWorkerModule=O;C.getCaretAtPoint=Z;C.getSelectionRects=pa;C.preloadFont=function(k,f,b){f=Array.isArray(f)?f.join("\n"):""+f;ka({font:k,text:f},b)};Object.defineProperty(C,"__esModule",{value:!0})})
